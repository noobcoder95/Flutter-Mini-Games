...
class AlertNumbers extends State<AlertNumbersState> {
  ...
  List<Row> createRows() {
    ...
    List<Row> rowList = new List<Row>.filled(3, Row());
    for (var i = 0; i <= 2; i++) {
...
class AlertAbout extends StatelessWidget {
  static const String authorURL = "https://play.google.com/store/apps/details?id=org.noobcoder.sudoku";
  static const String releasesURL = "https://play.google.com/store/apps/details?id=org.noobcoder.sudoku";
  static const String sourceURL = "https://play.google.com/store/apps/details?id=org.noobcoder.sudoku";
  static const String licenseURL = "https://play.google.com/store/apps/details?id=org.noobcoder.sudoku";
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              InkWell(
                onTap: () async {
                  await launchUrlString(AlertAbout.releasesURL);
                },
                child: Text(
                  '1.1.0' + ' ',
                  style: TextStyle(
          ...
          Row(
            ...
            children: [
              ...
              InkWell(
                onTap: () async {
                  await launchUrlString(AlertAbout.authorURL);
                },
                child: Text(
                  'Anonymous',
                  style: TextStyle(
          ...
          Row(
            ...
            children: [
              ...
              InkWell(
                onTap: () async {
                  await launchUrlString(AlertAbout.licenseURL);
                },
                child: Text(
                  'Free',
                  style: TextStyle(
          ...
          Row(
            ...
            children: [
              InkWell(
                onTap: () async {
                  await launchUrlString(AlertAbout.sourceURL);
                },
                child: Text(
                  'Rate This App',
                  style: TextStyle(
