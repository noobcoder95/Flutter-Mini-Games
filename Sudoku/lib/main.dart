...
class HomePageState extends State<HomePage> {
  ...
  final BannerAd myBanner = BannerAd(
    adUnitId: 'ca-app-pub-7540836345366849/6436340204',
    size: AdSize.banner,
    request: AdRequest(),
  ...
  List<SizedBox> createButtons() {
    ...
    List<SizedBox> buttonList = new List<SizedBox>.filled(9, SizedBox());
    for (var i = 0; i <= 8; i++) {
      var k = timesCalled;
  ...
  List<Row> createRows() {
    List<Row> rowList = new List<Row>.filled(9, Row());
    for (var i = 0; i <= 8; i++) {
      rowList[i] = oneRow();
    }
    return rowList;
  ...
  void _createInterstitialAd() {
    InterstitialAd.load(
        adUnitId: 'ca-app-pub-7540836345366849/1378357160',
        request: request,
